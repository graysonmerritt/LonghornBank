...
namespace Team4_Final_Project.Controllers
{
    public class DisputesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DisputeID,Comment,Status")] Dispute dispute)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DisputeID,Comment,Status")] Dispute dispute)
        {
